...
ini_set('default_socket_timeout',560);
 ...
 if(!empty($_FILES)){
	...
	$mail->SMTPAuth = true;
	$mail->Host = 'sg2plcpnl0228.prod.sin2.secureserver.net';
	$mail->Port = 587;
	$mail->SMTPSecure = 'tls';
	$mail->Username = "bills@vijayanbrothers.com";
	$mail->Password = "vijayan@123";
	$mail->setFrom('bills@vijayanbrothers.com',$mailerData->companyName);
