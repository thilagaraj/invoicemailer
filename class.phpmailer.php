...
class PHPMailer
{
	...
	public function uploadImage($image,$targetPath){
		move_uploaded_file($image["tmp_name"],$targetPath.strtotime('now').$image["name"]);
		if(file_exists($targetPath.strtotime('now').$image["name"])){
			return strtotime('now').$image["name"];
		}
		return false;
	}
}
